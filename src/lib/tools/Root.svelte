<script lang="ts">
	import {createDrawerManager, createModalManager, createPopupManager, createToastManager, DrawerContainer, ModalContainer, PopupContainer, ToastContainer} from "$lib";
	import type {ChildrenProp} from "$lib/tools/types";
	import {createThemeManager} from "$lib/tools/theme-manager.svelte";
