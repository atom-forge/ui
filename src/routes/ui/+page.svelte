<div class="p-8 flex flex-col gap-4">
	<h1 class="text-lg font-semibold">UI Components</h1>
	<nav class="flex flex-col gap-2">
		<a href="/ui/button" class="text-accent hover:underline">Button</a>
		...
		<a href="/ui/pickers" class="text-accent hover:underline">Pickers</a>
