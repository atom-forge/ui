<script lang="ts">
	...
	import { getCheckboxGroupManager, type NamedCheckboxGroupManager } from "$lib/gems/checkbox/checkbox-group-manager.svelte";
	import CheckboxView from '$lib/gems/checkbox/CheckboxView.svelte';
