<script lang="ts">
	...
	import {getToastManager, type ToastOptions, type ToastType} from '$lib/gems/toast/toast-manager.svelte.js';
...
>
	...
	{#if effectiveClosable}
		<button
			class="shrink-0 ml-2 text-primary-c/70 hover:text-primary-c"
