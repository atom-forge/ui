<script lang="ts">
	...
	const lineBase = 'bg-base-b';
	const defaultDotCls = 'w-3 h-3 rounded-full bg-secondary border-2 border-control-m shrink-0';
</script>
		...
		<div class="relative grid grid-cols-[1fr_2rem_1fr]">
			...
			{#each items as item, i}
				...
				{#if onLeft}
					...
					<div class="pb-6 pr-4 min-w-0">{@render children(item)}</div>
