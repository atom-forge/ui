<script lang="ts">
	import type {AnyProp, ChildrenProp, ClassProp} from "$lib";
...
<div class={twMerge("rounded-lg bg-raised border border-raised-b text-control-c overflow-hidden", effectiveShadowClass, classes)}
     {...props}>
	{@render children()}
</div>
