<script lang="ts">
	import Tooltip from "../../../../src/lib/gems/tooltip/Tooltip.svelte";
	...
	const avatarClasses = $derived(twMerge(
		'rounded-full font-bold flex items-center justify-center shrink-0 select-none overflow-hidden bg-base',
		sizeClass,
		classes,
	));
</script>
